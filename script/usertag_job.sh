...
hadoop jar user_tag.jar com.bcdata.analysis.yinni.UserTagMain -files url_tags.txt -libjars aho-corasick-double-array-trie-1.1.0.jar,commons-lang3-3.7.jar  ${IN_PATH} ${OUT_PATH}
